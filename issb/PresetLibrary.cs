...
{
    /// <summary>
    /// Представляет собой библиотеку предустановленных элементов, изображений-фонов и шаблонов фона раскадровки, загружаемую с помощью конфигурационного файла в XML-формате (см. ПЗ)
    /// </summary>
